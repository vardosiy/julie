...
//
//	void onAddBtnReleased();
//	void onDeleteBtnReleased();
//
////-----------------------------------------------------------------------------
//private:
//	void onItemSelected(const QItemSelection& _selection);
//
//	void addEntity(const std::string& _name);
//	void addMaterial(const std::string& _name);
//
//	void deleteEntity(const QModelIndex& _idx);
//	void deleteMaterial(const QModelIndex& _idx);
//	void deleteItems(const QItemSelectionModel& _selectionModel, std::function<void(const QModelIndex&)>&& _deleteFun);
//
...
//
//	std::string computeEntityName() const;
//	std::string computeMaterialName() const;
//	static std::string computeItemName(
