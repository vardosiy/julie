...
{
public:
	static std::unique_ptr<Texture> load2dTextureFromFile(std::string_view _filePath);
	static std::unique_ptr<CubeTexture> loadCubeTextureFromFile(std::string_view _filePath);
