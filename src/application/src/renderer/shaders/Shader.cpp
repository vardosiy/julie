...
bool checkShaderCompilationSucceded(uint32_t _shaderHandle) noexcept
{
	int status;
...
int loadShader(uint32_t _type, std::string_view _filePath)
{
	int shader{ 0 };
...
bool checkProgramLinkageSucceded(uint32_t _programHandle) noexcept
{
	int status;
...
uint32_t loadProgram(uint32_t _vs, uint32_t _fs)
{
...
std::unique_ptr<Shader> Shader::create(std::string_view _vsPath, std::string_view _fsPath)
{
	...
	if (const uint32_t vs = details::loadShader(GL_VERTEX_SHADER, _vsPath))
	{
		if (const uint32_t fs = details::loadShader(GL_FRAGMENT_SHADER, _fsPath))
		{
			if (const uint32_t program = details::loadProgram(vs, fs))
			{
...
void Shader::setUniformValue(int _location, int _val) const
{
...
void Shader::setUniformValue(int _location, float _val) const
{
...
void Shader::setUniformValue(int _location, const glm::vec2 & _val) const
{
...
void Shader::setUniformValue(int _location, const glm::vec3 & _val) const
{
...
void Shader::setUniformValue(int _location, const glm::vec4 & _val) const
{
...
void Shader::setUniformValue(int _location, const glm::mat4 & _val) const
{
...
void Shader::setUniformValue(int _location, uint32_t _count, const int * _val) const
{
...
void Shader::setUniformValue(int _location, uint32_t _count, const glm::vec3 * _val) const
{
...
void Shader::setUniformValue(int _location, uint32_t _count, const glm::vec4 * _val) const
{
