...
std::unique_ptr<CubeTexture> CubeTexture::create(std::string_view _filePath, GLenum _tiling)
{
	...
	glGenTextures(1, &cubeTexture->m_handle);
	glBindTexture(GL_TEXTURE_CUBE_MAP, cubeTexture->m_handle);
...
void CubeTexture::bind(unsigned short _slot) const noexcept
{
